  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-background relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* LEFT PANEL */}
        <section className={`w-full lg:w-[480px] bg-surface-container-lowest border-r border-outline-variant flex flex-col transition-all duration-500 ${activeTab === 'graph' ? 'lg:-ml-[480px]' : ''}`}>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8 flex flex-col">
            <AnimatePresence mode="wait">
              ...
              {isLoadingHistory ? (
                ...
                <motion.div className="flex-1 flex items-center justify-center text-center">
                  <div>
          ...
          <div className="p-4 border-t border-outline-variant bg-surface-container-lowest">
            ...
            <div className="flex items-end bg-surface-container border border-outline-variant rounded-2xl p-2">
        ...
        <section className={`flex-1 bg-surface-container-lowest flex items-center justify-center ${activeTab === 'chat' ? 'opacity-40 blur-sm' : ''}`}>
          {/* graph unchanged */}
        </section>
